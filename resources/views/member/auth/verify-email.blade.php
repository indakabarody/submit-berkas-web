...
<div class="text-center">
    ...
    <p class="text-muted font-14 mt-2"> Kami telah mengirim email ke <b>{{ Auth::user()->email }}</b>.
        Silakan klik link tersebut untuk verifikasi email.</p>
    ...
    <form action="{{ route('member.verification.send') }}" method="POST">
        @csrf
        <button type="submit" class="btn w-100 btn-primary waves-effect waves-light mt-3">Kirim Ulang</button>
    </form>
</div>

<footer class="footer footer-alt">
    <p class="text-muted">&copy; {{ date('Y') }} The Journalish </p>
</footer>
@endsection
