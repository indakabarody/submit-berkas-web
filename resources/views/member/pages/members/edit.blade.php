                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Masukkan Nama" value="{{ $member->name }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Masukkan Email" value="{{ $member->email }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input name="phone" type="number" min="0" class="form-control @error('phone') is-invalid @enderror" id="phone" placeholder="Masukkan No Telp" value="{{ $member->phone }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="address" class="form-control @error('address') is-invalid @enderror" id="address" placeholder="Masukkan Alamat Sesuai Identitas">{{ $member->address }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input name="institution" type="text" class="form-control @error('institution') is-invalid @enderror" id="institution" placeholder="Masukkan Nama Institusi/Organisasi/PT/Sekolah/Tempat Bekerja" value="{{ $member->institution }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input name="is_book_publisher" type="checkbox" class="form-check-input" id="customCheck1" value="1" @if ($member->is_book_publisher == 1) checked @endif>
                                                    <label class="form-check-label" for="customCheck1">Penerbitan buku /3 judul (6 Bulan)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input name="is_training_organizer" type="checkbox" class="form-check-input" id="customCheck2" value="1" @if ($member->is_training_organizer == 1) checked @endif>
                                                    <label class="form-check-label" for="customCheck2">Penyelenggara Diklat / 10 kegiatan (1 Tahun)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input name="is_active_participant" type="checkbox" class="form-check-input" id="customCheck3" value="1" @if ($member->is_active_participant == 1) checked @endif>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input name="is_activated" type="checkbox" class="form-check-input" id="customSwitch1" value="1" @if ($member->is_activated == 1) checked @endif>
