                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                @isset($admin->image)
                                    <img src="{{ asset('storage/admin/images/'.$admin->id.'/'.$admin->image) }}" alt="image">
                                @else
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <div class="card-header cursor-pointer">
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">Detail Admin</h3>
                    </div>
                    {{--end::Card title--}}
                    {{--begin::Action--}}
                    <a href="{{ route('admin.admins.edit', $admin->id) }}" class="btn btn-primary align-self-center">Edit</a>
                    {{--end::Action--}}
                </div>
                {{--begin::Card header--}}
                {{--begin::Card body--}}
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        {{--begin::Col--}}
                        <div class="col-lg-8">
                            <span class="fw-bolder fs-6 text-dark">{{ $admin->name }}</span>
                        </div>
                        {{--end::Col--}}
                    </div>
                    {{--end::Row--}}
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <span class="fw-bolder fs-6 me-2">{{ $admin->email }}</span>
                        </div>
                        {{--end::Col--}}
                    </div>
                    {{--end::Input group--}}
