            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" action="{{ route('admin.guides.update', $guide->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                <label for="inputContent3"
                                    class="col-4 col-xl-3 col-form-label">Isi Panduan</label>
                                <div class="col-8 col-xl-9">
                                    <div id="snow-editor" style="height: 300px;">{!! $guide->content !!}</div>
                                    <input type="hidden" name="content" id="content" value="{!! $guide->content !!}">
