...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="78">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="client-images">
                                <img src="{{asset('themes/guest/images/clients/1.png')}}" alt="logo-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="client-images">
                                <img src="{{asset('themes/guest/images/clients/3.png')}}" alt="logo-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="client-images">
                                <img src="{{asset('themes/guest/images/clients/4.png')}}" alt="logo-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="client-images">
                                <img src="{{asset('themes/guest/images/clients/6.png')}}" alt="logo-img" class="mx-auto img-fluid d-block">
                            </div>
                        </div>
                    </div> {{-- end row --}}
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{asset('themes/guest/images/icons/layers.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{asset('themes/guest/images/icons/core.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{asset('themes/guest/images/icons/paperdesk.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{asset('themes/guest/images/icons/solarsystem.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{asset('themes/guest/images/icons/datatext.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="{{asset('themes/guest/images/icons/browserscript.png')}}" alt="">
                            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{asset('themes/guest/images/demo/index_1.jpg')}}" alt="" class="img-fluid mx-auto d-block">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{asset('themes/guest/images/demo/index_2.jpg')}}" alt="" class="img-fluid mx-auto d-block">
                                <div class="p-3 text-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{asset('themes/guest/images/demo/index_3.jpg')}}" alt="" class="img-fluid mx-auto d-block">
                                <div class="p-3 text-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{asset('themes/guest/images/demo/index_4.jpg')}}" alt="" class="img-fluid mx-auto d-block">
                                <div class="p-3 text-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{asset('themes/guest/images/demo/index_5.jpg')}}" alt="" class="img-fluid mx-auto d-block">
                                <div class="p-3 text-center">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <a href="#" class="text-dark">
                                <img src="{{asset('themes/guest/images/demo/index_6.jpg')}}" alt="" class="img-fluid mx-auto d-block">
                                <div class="p-3 text-center">
        ...
        <section class="section">
            <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="feature-img">
                            <img src="{{asset('themes/guest/images/features-img/img-2.png')}}" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row align-items-center mt-5">
                    ...
                    <div class="col-lg-6">
                        <div class="feature-img">
                            <img src="{{asset('themes/guest/images/features-img/img-1.png')}}" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                </div>
                {{-- end row --}}
        ...
        <section class="section pb-0 bg-gradient" id="pricing">
            <div class="bg-shape">
                <img src="{{asset('themes/guest/images/bg-shape.png')}}" alt="" class="img-fluid mx-auto d-block">
            </div>
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                ...
                <div class="row">
                        ...
                        <div class="testi-box mt-4">
                            ...
                            <div class="p-4">
                                <div class="testi-img float-start me-2">
                                    <img src="{{asset('themes/guest/images/testi/img-2.png')}}" alt="" class="rounded-circle">
                                </div>
                                <div>
                    ...
                    <div class="col-lg-4">
                        <div class="testi-box mt-4">
                            ...
                            <div class="p-4">
                                <div class="testi-img float-start me-2">
                                    <img src="{{asset('themes/guest/images/testi/img-1.png')}}" alt="" class="rounded-circle">
                                </div>
                                <div>
                    ...
                    <div class="col-lg-4">
                        <div class="testi-box mt-4">
                            ...
                            <div class="p-4">
                                <div class="testi-img float-start me-2">
                                    <img src="{{asset('themes/guest/images/testi/img-3.png')}}" alt="" class="rounded-circle">
                                </div>
                                <div>
        ...
        <section class="section pb-0 bg-gradient" id="contact">
            <div class="bg-shape">
                <img src="{{asset('themes/guest/images/bg-shape-light.png')}}" alt="" class="img-fluid mx-auto d-block">
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
            ...
            <div class="container-fluid">
                <div class="row mb-5">
                    <div class="col-lg-4">
                        <div class="pe-lg-4">
                            <div class="mb-4">
                                <img src="{{asset('themes/guest/images/logo-light.png')}}" alt="" height="20">
                            </div>
