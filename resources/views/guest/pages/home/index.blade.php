...
<head>
    ...
    {{--Magnific popup css--}}
    <link rel="stylesheet" href="{{ asset('themes/guest/css/magnific-popup.css') }}">
    {{--Themify icon css--}}
    <link rel="stylesheet" href="{{ asset('themes/guest/css/themify-icons.css') }}">
    {{--Fontawesome icon css--}}
    <link rel="stylesheet" href="{{ asset('themes/guest/css/all.min.css') }}">
    {{--animated css--}}
    <link rel="stylesheet" href="{{ asset('themes/guest/css/animate.min.css') }}">
    {{--ytplayer css--}}
    <link rel="stylesheet" href="{{ asset('themes/guest/css/jquery.mb.YTPlayer.min.css') }}">
    {{--Owl carousel css--}}
    <link rel="stylesheet" href="{{ asset('themes/guest/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/guest/css/owl.theme.default.min.css') }}">
    {{--custom css--}}
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-transparent">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <img src="{{ asset('themes/guest/img/logo-white.png') }}" alt="logo" class="img-fluid"/>
            </a>
            ...
            <div class="collapse navbar-collapse h-auto" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto menu">
                    ...
                    <li><a href="{{ route('member.login') }}" class="btn solid-white-btn check-btn">Login Member</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
<div class="main">
    ...
    {{--hero section start--}}
    <section class="hero-equal-height ptb-70" style="background: url('{{ asset('themes/guest/img/t3-hero-shape.svg') }}')no-repeat top center / cover">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-5">
                    <div class="hero-slider-content text-white pt-4">
                        <span>Digital Marketing</span>
                        <h1 class="text-white">Marketing Agency</h1>
                        <p class="lead">Holisticly procrastinate mission-critical is the convergence with reliable customer service. Assertively underwhelm. </p>
                ...
                <div class="col-md-12 col-lg-7">
                    <div class="image-wrap d-flex justify-content-end">
                        <img src="{{ asset('themes/guest/img/t3-hero-img.svg') }}" alt="hero" class="img-fluid custom-width">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="promo-single px-4 py-5 text-center rounded shadow-sm color-1 color-1-bg">
                        <i class="fas fa-globe icon-md d-block mb-4"></i>
                        <h5 class="mb-0">World Top 50 Consulting Firms</h5>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="promo-single px-4 py-5 text-center rounded shadow-sm color-1 color-1-bg">
                        <i class="fas fa-user icon-md d-block mb-4"></i>
                        <h5 class="mb-0">99.9% Client Satisfaction</h5>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="promo-single px-4 py-5 text-center rounded shadow-sm color-1 color-1-bg">
                        <i class="fas fa-briefcase icon-md d-block mb-4"></i>
                        <h5 class="mb-0">Over 2,000+ Business Cases</h5>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="promo-single px-4 py-5 text-center rounded shadow-sm color-1 color-1-bg">
                        <i class="fas fa-award icon-md d-block mb-4"></i>
                        <h5 class="mb-0">Operated in 5+ Countries</h5>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 promo-col">
                                <div class="promo-item">
                                    <div class="promo-img">
                                        <img src="{{ asset('themes/guest/img/increase.svg') }}" alt="services" width="60">
                                    </div>
                                    <h5>Increased Traffic</h5>
                                    <p>Wash your hands frequently more then 20s</p>
                                    <div class="promo-bottom-shape">
                                        <img src="{{ asset('themes/guest/img/promo-box-shape-bottom.png') }}" alt="shape">
                                    </div>
                                </div>
                                <div class="promo-item">
                                    <div class="promo-img">
                                        <img src="{{ asset('themes/guest/img/search-engine.svg') }}" alt="services" width="60">
                                    </div>
                            ...
                            <div class="col-md-6 col-sm-6 promo-col">
                                <div class="promo-item">
                                    <div class="promo-img">
                                        <img src="{{ asset('themes/guest/img/credit-card.svg') }}" alt="services" width="60">
                                    </div>
                                ...
                                <div class="promo-item">
                                    <div class="promo-img">
                                        <img src="{{ asset('themes/guest/img/interface.svg') }}" alt="services" width="60">
                                    </div>
                                    <h5>Page Rankings</h5>
        ...
        <div class="row m-0">
            <div class="col-lg-6 col-md-12 p-0">
                <div class="free-trial-image text-center">
                    <img src="{{ asset('themes/guest/img/cta-2-girl-img.jpg') }}" alt="image" class="img-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-heading text-center">
                        ...
                        <h2>We Provide Better Services</h2>
                        <span class="animate-border mr-auto ml-auto mb-4"></span>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-5">
                    <div class="image-wrap">
                        <img src="{{ asset('themes/guest/img/tab-img.png') }}" alt="why choose us" class="img-fluid m-auto">
                    </div>
                </div>
    ...
    {{--call to action section start--}}
    <section class="call-to-action ptb-70" style="background: url('{{ asset('themes/guest/img/cta-bg.jpg') }}')no-repeat center center / cover">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
        ...
        <div class="cta-image d-none d-lg-block d-md-block">
            <img src="{{ asset('themes/guest/img/cta-1-man.svg') }}" width="200" class="img-left" alt="cta">
            <img src="{{ asset('themes/guest/img/cta-1-mike.svg') }}" width="200" class="img-right" alt="cta">
        </div>
    </section>
    {{--call to action section end--}}
                    ...
                    <div class="portfolio-container" id="MixItUp">
                        <div class="mix portfolio-item branding" data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details.html" target="_blank">
                                    ...
                                    <img class="img-fluid" src="{{ asset('themes/guest/img/portfolios/3.jpg') }}" alt="portfolio"/>
                        ...
                        <div class="mix portfolio-item other animation" data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details.html" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="img-fluid" src="{{ asset('themes/guest/img/portfolios/2.jpg') }}" alt="portfolio"/>
                                    <div class="content-details fadeIn-bottom text-white">
                        ...
                        <div class="mix portfolio-item animation" data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details.html" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="img-fluid" src="{{ asset('themes/guest/img/portfolios/4.jpg') }}" alt="portfolio"/>
                                    <div class="content-details fadeIn-bottom text-white">
                        ...
                        <div class="mix portfolio-item branding" data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details.html" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="img-fluid" src="{{ asset('themes/guest/img/portfolios/1.jpg') }}" alt="portfolio"/>
                                    <div class="content-details fadeIn-bottom text-white">
                                        <h5 class="text-white mb-1">Web UI/UX Design</h5>
                                        <p>Web, Design</p>
                                    </div>
                        ...
                        <div class="mix portfolio-item animation other" data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details.html" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="img-fluid" src="{{ asset('themes/guest/img/portfolios/5.jpg') }}" alt="portfolio"/>
                                    <div class="content-details fadeIn-bottom text-white">
                        ...
                        <div class="mix portfolio-item branding " data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details.html" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="img-fluid" src="{{ asset('themes/guest/img/portfolios/6.jpg') }}" alt="portfolio"/>
                                    <div class="content-details fadeIn-bottom text-white">
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        <div class="price-img pt-5">
                            <img src="{{ asset('themes/guest/img/priching-img-1.png') }}" alt="price" width="120" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card popular-price text-center single-pricing-pack">
                        <div class="price-img pt-5">
                            <img src="{{ asset('themes/guest/img/priching-img-2.png') }}" alt="price" width="120" class="img-fluid">
                        </div>
                        <div class="card-header py-4 border-0 pricing-header">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        <div class="price-img pt-5">
                            <img src="{{ asset('themes/guest/img/priching-img-3.png') }}" alt="price" width="120" class="img-fluid">
                        </div>
                        <div class="card-header py-4 border-0 pricing-header">
    ...
    <section class="testimonial-section ptb-100" style="background: url('{{ asset('themes/guest/img/testimonial-bg.png') }}')no-repeat center center / cover">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-5">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="testimonial-content-wrap">
                        <img src="{{ asset('themes/guest/img/testimonial-arrow-top.png') }}" class="img-fluid testimonial-tb-shape shape-top" alt="testimonial shape">
                        <div class="owl-carousel owl-theme client-testimonial-1 custom-dot testimonial-shape">
                            <div class="item">
                                <div class="testimonial-quote-wrap">
                                    <div class="media author-info mb-3">
                                        <div class="author-img mr-3">
                                            <img src="{{ asset('themes/guest/img/client-1.jpg') }}" alt="client" class="img-fluid">
                                        </div>
                            ...
                            <div class="item">
                                <div class="testimonial-quote-wrap">
                                    <div class="media author-info mb-3">
                                        <div class="author-img mr-3">
                                            <img src="{{ asset('themes/guest/img/client-2.jpg') }}" alt="client" class="img-fluid">
                                        </div>
                                        <div class="media-body text-white">
                            ...
                            <div class="item">
                                <div class="testimonial-quote-wrap">
                                    <div class="media author-info mb-3">
                                        <div class="author-img mr-3">
                                            <img src="{{ asset('themes/guest/img/client-3.jpg') }}" alt="client" class="img-fluid">
                                        </div>
                                        <div class="media-body text-white">
                            ...
                            <div class="item">
                                <div class="testimonial-quote-wrap">
                                    <div class="media author-info mb-3">
                                        <div class="author-img mr-3">
                                            <img src="{{ asset('themes/guest/img/client-4.jpg') }}" alt="client" class="img-fluid">
                                        </div>
                                        <div class="media-body text-white">
                                            <h5 class="mb-0 text-white">John Charles</h5>
                                            <span>BizBite</span>
                        ...
                        <img src="{{ asset('themes/guest/img/testimonial-arrow-bottom.png') }}" class="img-fluid testimonial-tb-shape shape-bottom" alt="testimonial shape">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-blog-card card border-0 shadow-sm">
                        <div class="blog-img position-relative">
                            <img src="{{ asset('themes/guest/img/blog/1.jpg') }}" class="card-img-top" alt="blog">
                            <div class="meta-date">
                                <strong>24</strong>
                                <small>Apr</small>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="single-blog-card card border-0 shadow-sm">
                        <div class="blog-img position-relative">
                            <img src="{{ asset('themes/guest/img/blog/2.jpg') }}" class="card-img-top" alt="blog">
                            <div class="meta-date">
                                <strong>24</strong>
                                <small>Apr</small>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="single-blog-card card border-0 shadow-sm">
                        <div class="blog-img position-relative">
                            <img src="{{ asset('themes/guest/img/blog/3.jpg') }}" class="card-img-top" alt="blog">
                            <div class="meta-date">
                                <strong>24</strong>
                                <small>Apr</small>
                            </div>
    ...
    <div class="client-section ptb-100" style="background: url('{{ asset('themes/guest/img/client-bg.jpg') }}')no-repeat center center / cover">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-6">
                ...
                <div class="col-md-10 col-lg-9">
                    <div class="owl-carousel owl-theme clients-carousel dot-indicator client-logo-wrap">
                        <div class="item single-client">
                            <img src="{{ asset('themes/guest/img/clients-logo-01.png') }}" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="{{ asset('themes/guest/img/clients-logo-02.png') }}" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="{{ asset('themes/guest/img/clients-logo-03.png') }}" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="{{ asset('themes/guest/img/clients-logo-04.png') }}" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="{{ asset('themes/guest/img/clients-logo-05.png') }}" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="{{ asset('themes/guest/img/clients-logo-06.png') }}" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="{{ asset('themes/guest/img/clients-logo-07.png') }}" alt="client logo" class="client-img">
                        </div>
                        <div class="item single-client">
                            <img src="{{ asset('themes/guest/img/clients-logo-08.png') }}" alt="client logo" class="client-img">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row footer-top-wrap">
                        <div class="col-md-4 col-sm-6">
                            <div class="footer-nav-wrap text-white">
                                <img src="{{ asset('themes/guest/img/logo-white.png') }}" alt="logo" class="mb-2">
...
{{--jQuery--}}
<script src="{{asset('themes/guest/js/jquery-3.5.0.min.js')}}"></script>
{{--Popper js--}}
<script src="{{asset('themes/guest/js/popper.min.js')}}"></script>
{{--Bootstrap js--}}
...
{{--jquery easing js--}}
<script src="{{asset('themes/guest/js/jquery.easing.min.js')}}"></script>
{{--jquery ytplayer js--}}
<script src="{{asset('themes/guest/js/jquery.mb.YTPlayer.min.js')}}"></script>
{{--Isotope filter js--}}
<script src="{{asset('themes/guest/js/mixitup.min.js')}}"></script>
{{--wow js--}}
<script src="{{asset('themes/guest/js/wow.min.js')}}"></script>
{{--owl carousel js--}}
<script src="{{asset('themes/guest/js/owl.carousel.min.js')}}"></script>
{{--countdown js--}}
<script src="{{asset('themes/guest/js/jquery.countdown.min.js')}}"></script>
{{--jquery easypiechart--}}
<script src="{{asset('themes/guest/js/jquery.easy-pie-chart.js')}}"></script>
{{--custom js--}}
<script src="{{asset('themes/guest/js/scripts.js')}}"></script>
</body>
</html>
