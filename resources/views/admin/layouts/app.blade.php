				...
				<div class="container-fluid">
					<ul class="list-unstyled topnav-menu float-end mb-0">
						<li class="dropdown notification-list topbar-dropdown">
							...
							<img src="@isset(Auth::user()->image) {{ asset('storage/admin/images/'.Auth::user()->id.'/'.Auth::user()->image) }} @else {{ asset('themes/user/images/users/blank.png') }} @endisset" alt="user-image" class="rounded-circle">
				...
				<div class="h-100" data-simplebar>
					...
					<div id="sidebar-menu">
						<ul id="side-menu">
							...
							<li class="menu-title mt-2">Menu Admin</li>
							<li>
