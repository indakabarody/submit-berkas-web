                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input name="is_writer" type="checkbox" class="form-check-input" id="customCheck1" value="1" @if ($member->is_writer == 1) checked @endif>
                                                    <label class="form-check-label" for="customCheck1">Penulis</label>
                                                </div>
                                                <div class="form-check">
                                                    <input name="is_training_member" type="checkbox" class="form-check-input" id="customCheck2" value="1" @if ($member->is_training_member == 1) checked @endif>
                                                    <label class="form-check-label" for="customCheck2">Member Diklat</label>
                                                </div>
                                                <div class="form-check">
                                                    <input name="is_reader" type="checkbox" class="form-check-input" id="customCheck3" value="1" @if ($member->is_reader == 1) checked @endif>
