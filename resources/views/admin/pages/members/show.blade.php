                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check">
                                                <input name="is_training" type="checkbox" class="form-check-input" id="customCheck2" value="1" @if ($member->is_training == 1) checked @endif disabled>
                                                <label class="form-check-label" for="customCheck2">Diklat</label>
                                            </div>
                                            <div class="form-check">
                                                <input name="is_internship" type="checkbox" class="form-check-input" id="customCheck3" value="1" @if ($member->reader == 1) checked @endif disabled>
                                                <label class="form-check-label" for="customCheck3">Internship</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
