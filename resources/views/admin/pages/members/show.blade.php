                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check">
                                                <input name="is_book_publisher" type="checkbox" class="form-check-input" id="customCheck1" value="1" @if ($member->is_book_publisher == 1) checked @endif disabled>
                                                <label class="form-check-label" for="customCheck1">Penerbitan buku /3 judul (6 Bulan)</label>
                                            </div>
                                            <div class="form-check">
                                                <input name="is_training_organizer" type="checkbox" class="form-check-input" id="customCheck2" value="1" @if ($member->is_training_organizer == 1) checked @endif disabled>
                                                <label class="form-check-label" for="customCheck2">Penyelenggara Diklat / 10 kegiatan (1 Tahun)</label>
                                            </div>
                                            <div class="form-check">
                                                <input name="is_active_participant" type="checkbox" class="form-check-input" id="customCheck3" value="1" @if ($member->is_active_participant == 1) checked @endif disabled>
