	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<a href="{{ route('admin.admins.create') }}" class="btn btn-sm btn-blue waves-effect waves-light float-end">
						<i class="mdi mdi-plus-circle"></i> Tambah Admin
						</a>
                        <div class="mb-4"></div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="table-user">
										...
										<a href="javascript:void(0);" class="text-body fw-semibold">{{ $admin->name }}  @if ($admin->id == Auth::user()->id) (Saya) @endif</a>
									</td>
									<td>{{ $admin->email }}</td>
									<td>
									...
									<td>
										<div class="btn-group">
											...
											<div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="setDelete('{{ route('admin.admins.destroy', $admin->id) }}');">Hapus</a>
                                                @endif
											</div>
										</div>
									</td>
		...
		<div class="modal-content">
			<form id="deleteForm" method="POST">
				...
				<div class="modal-body">
					<p>Yakin ingin menghapus Admin?</p>
				</div>
